 ...
 * <p>
 * The only known implementation is {@link GamePreviewLoaderLifecycleHandler} which is base on loaders
 *
 * @author Artur Vasilov
 */
public interface GamePreviewLifecycleHandler {
     ...
     * Use {@link Observable#compose(Observable.Transformer)} with with method
     * <p>
     * This method provides almost the same functionality as {@link GamePreviewLifecycleHandler#load(int)}
    ...
    @NonNull
    <T> Observable.Transformer<T, T> add(int id);
